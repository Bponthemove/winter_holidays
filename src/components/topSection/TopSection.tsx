  ...
  return (
    <section  className={ styles.topSection }>
      <div  className={h1 ? [styles.h1Container, styles.h1ContainerAnimate].join(' ') : styles.h1Container}
            style={firstRenderRef.current && scroll !== undefined ? {transform: `translateY(${desktop ? scroll/5 : scroll/1.8}%)`} : {}}
      >
        <h1 className={menu ? [styles.h1, styles.h1Grey, styles.h1Active].join(' ') : [styles.h1, styles.h1Grey].join(' ')}
            style={firstRenderRef.current && scroll !== undefined ? {opacity: 1-(scroll/300)} : {opacity: 1}}
        >
          BACKCOUNTRY
        </h1>
        <h1 className={menu ? [styles.h1, styles.h1White, styles.h1Active].join(' ') : [styles.h1, styles.h1White].join(' ')}
            style={firstRenderRef.current && scroll !== undefined ? {opacity: scroll/300} : {opacity: 0}}
        >
          <span>
      ...
      <div  className={menu ? [styles.imgContainer, styles.imgContainerActive].join(' ') : styles.imgContainer}
            style={firstRenderRef.current && scroll !== undefined ? {opacity: `${1 -(scroll/500)}`} : {}}
      >
      ...
      <div 
        ...
        style={firstRenderRef.current && scroll !== undefined ? {transform: `translateY(-${scroll/22}%)`} : {}}
      >
